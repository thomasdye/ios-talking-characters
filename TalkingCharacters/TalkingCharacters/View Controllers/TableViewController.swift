...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
     ...
     override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.tableViewCellImage.image = Model.shared.image(for: Model.shared.characters[indexPath.row])
     ...
     */
     ...
     override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "ShowCharacterSegue" {
            ...
            let cellCharacter = Model.shared.characters[indexPath.row]
            
            detailVC.cellCharacter = cellCharacter.rawValue
